...
final class ThumbnailGeneratorTest extends TestCase
{
 ...
 public function test_five_real_jpegs_and_three_distinct_designs_decode(): void {
  ...
  $root=sys_get_temp_dir().'/clipforge-thumbnails-'.bin2hex(random_bytes(8));mkdir($root,0700);$runner=new ProcessRunner([$bin],$root);$storage=new LocalPrivateStorage($root,20000000);

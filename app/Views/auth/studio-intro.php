<section class="auth-story" aria-labelledby="auth-story-title">
    ...
    <ol class="auth-story-list" aria-label="Do vídeo ao clipe">
        <li><span>01</span>Traga seu vídeo para o estúdio</li>
        <li><span>02</span>Encontre trechos com ajuda da IA</li>
        <li><span>03</span>Revise, ajuste e exporte em MP4</li>
    </ol>
    <p class="auth-story-note">Sua edição. Seu ritmo. A decisão final é sua.</p>
</section>

...
/** @var string $logoId */
$logoId ??= 'logo';
$logoName=$platformBranding['name']??'ClipForge';
?>
...
<span id="<?= e($logoId) ?>" class="brand-wordmark"><?php if ($logoName==='ClipForge'): ?>Clip<span>Forge</span><?php else: ?><?= e($logoName) ?><?php endif; ?></span>
<?php endif; ?>

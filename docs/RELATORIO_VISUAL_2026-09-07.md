...
- Três testes `MediaPipeConsentServiceTest` exigem o banco isolado `clipforge_phase5_test` e foram excluídos explicitamente do run Unit final. Os skips reportados pelo próprio PHPUnit continuam identificados no XML.
